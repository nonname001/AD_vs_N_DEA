...
do_GSEA <- function (top_input, pvcutoff, gmt, group_name, Protein.ID.Column=NULL) {
  ...
  em2 <- GSEA(gl, TERM2GENE = gmt.2, pAdjustMethod = "BH", nPerm=10000, minGSSize = 2, maxGSSize = 999999, seed = 123, pvalueCutoff = 1)
